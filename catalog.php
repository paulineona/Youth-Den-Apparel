...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      type="image/png"
      href="public/images/logo/logo-arvene-ver.png"
    />
        ...
        <div class="container navbar">
          <div class="navbar-left">
            <div class="navbar-logo">
              <a href="index.php"
                ><img src="public/images/logo/logo-arvene-ver.png" alt="logo"
              /></a>
            </div>
            <div class="overlay">
              <ul class="menu">
      ...
      <div class="container">
        ...
        <div class="cards">
          <div class="card">
            <a href="#">
              <img
                src="public/images/shirts/shirt front only/plantsmusic.png"
                alt=""
                class="card__image"
              />
          ...
          <div class="card">
            <a href="#">
              <img
                src="public/images/shirts/shirt front only/wastedyouth_white.png"
                alt=""
                class="card__image"
              />
              <div class="card__content">
          ...
          <div class="card">
            <a href="#">
              <img
                src="public/images/shirts/shirt with back/nofear_back.png"
                alt=""
                class="card__image"
              />
              <div class="card__content">
          ...
          <div class="card">
            <a href="#">
              <img
                src="public/images/shirts/shirt with back/outdoorclub_cream_back.png"
                alt=""
                class="card__image"
              />
              <div class="card__content">
          ...
          <div class="card">
            <a href="#">
              <img
                src="public/images/shirts/shirt front only/dance.png"
                alt=""
                class="card__image"
              />
              <div class="card__content">
          ...
          <div class="card">
            <a href="#">
              <img
                src="public/images/shirts/shirt with back/refresh_back.png"
                alt=""
                class="card__image"
              />
              <div class="card__content">
